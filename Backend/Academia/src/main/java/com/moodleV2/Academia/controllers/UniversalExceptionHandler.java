...
//        links.add(linkTo(methodOn(ProfesorController.class).getAll(PageRequest.of(0, 10))).withRel("profesori"));
    ...
    @org.springframework.web.bind.annotation.ExceptionHandler(ProfesorNotFoundException.class)
    ...
    @org.springframework.web.bind.annotation.ExceptionHandler(LengthPaginationException.class)
    ...
    @org.springframework.web.bind.annotation.ExceptionHandler(PropertyReferenceException.class)     // 422 Unprocessable Content? or 400 Bad Request?
    ...
    @org.springframework.web.bind.annotation.ExceptionHandler(SearchParamException.class)
    ...
    @org.springframework.web.bind.annotation.ExceptionHandler(HttpMessageNotReadableException.class)    // for the parsing errors from enums (should this be 406 Not Acceptable?)
    ...
    @org.springframework.web.bind.annotation.ExceptionHandler(ProfesorArchivedException.class)
    ...
    @org.springframework.web.bind.annotation.ExceptionHandler(DisciplinaNotFoundException.class)
